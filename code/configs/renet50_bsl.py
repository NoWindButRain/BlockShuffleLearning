...
is_resume = True
load_model = \
'/root/workspace/bsl/checkpoints/resnet50_bsl_ff_c23_classic_split/28_97.211211/resnet50_28_97.211211_220414215948.pth'
print('Init model...')
from models.resnet import ResNet50BSL
net = ResNet50BSL(num_class=1, is_train=is_train, is_bs_adv=True, is_rs_adv=True).eval().to(device)

from tools.train_bsl import TrainBSL
train = TrainBSL(net, device)
train.net_name = 'resnet50'
train.correct_str_test = '{:.2f}'

if is_train:
    train.correct_str = '{0:.2f} {1:.2f} {2:.2f} {4:.2f}'
    save_path = '../checkpoints/resnet50_bsl_ff_c23_classic_split/'
