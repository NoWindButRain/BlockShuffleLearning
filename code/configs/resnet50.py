...
is_resume = True
load_model = \
'/root/workspace/bsl/checkpoints/resnet50_ff_c23_classic_split/26_97.805368/resnet50_26_97.805368_220412054559.pth'
print('Init model...')
net = ResNet50(num_class=1, is_train=is_train).eval().to(device)
...
if is_train:
    ...
    save_path = '../checkpoints/resnet50_ff_c23_classic_split/'
