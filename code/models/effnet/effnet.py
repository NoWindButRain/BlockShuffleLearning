...
class Effb4Net(architectures.fornet.FeatureExtractor):
    def __init__(self, num_class=1, is_train=False, pretrained=True, progress=True, **kwargs):
        ...
        self.effnet = EfficientNet(num_class, norm_layer=None, **kwargs)
        if pretrained:
            ...
            if num_class != 1000:
                ...
                strict = False
            self.effnet.load_state_dict(state_dict, strict=strict)
